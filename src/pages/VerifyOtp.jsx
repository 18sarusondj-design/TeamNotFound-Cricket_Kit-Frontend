...
const VerifyOtp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // response.data.message contains the reset token
      navigate('/reset-password', { 
        state: { resetToken: response.data.message, message: 'OTP verified successfully.' } 
      });
    } catch (err) {
  ...
  return (
    <AuthLayout>
      <div className="auth-box glass-card">
        <h2>Enter OTP</h2>
        <p>Enter the 6-digit code sent to your email or mobile.</p>
